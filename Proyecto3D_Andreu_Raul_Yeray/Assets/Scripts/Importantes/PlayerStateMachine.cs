...
/// Coordina: movimiento, linterna, taquillas, objetos lanzables, inventario y muerte.
///
/// Coloca este script en PlayerArmature junto al resto de componentes.
/// </summary>
public class PlayerStateMachine : MonoBehaviour
{
    ...
    public PlayerThrowSystem  throwSystem;
    ...
    public System.Action<int>         OnBatteryCountChanged;  // int = cantidad actual
    ...
    private void Awake()
    {
        ...
        if (throwSystem    == null) throwSystem    = GetComponent<PlayerThrowSystem>();
    ...
    private void Start()
    {
        ...
        // Guardar velocidad original de carrera
        ...
        {
            // Monitorear cambios de IsHiding
        }
    }
    ...
    private void EvaluateState()
    {
        ...
        if (inputs != null)
        {
            float speed = new UnityEngine.Vector2(inputs.move.x, inputs.move.y).magnitude;
    ...
    private void ApplyStateRules()
    {
        switch (CurrentState)
        {
            case PlayerState.Aiming:
                ...
                BlockSprint();
                // No puede lanzar objetos mientras apunta
                if (throwSystem != null) throwSystem.enabled = false;
                break;

            case PlayerState.Hiding:
                // Todo bloqueado — lo gestiona LockerSystem
                if (throwSystem != null) throwSystem.enabled = false;
                break;
            ...
            case PlayerState.Idle:
                // Restaurar sistemas
                if (throwSystem != null) throwSystem.enabled = true;
                RestoreSprint();
                break;
        }
    }
    ...
    /// <summary>
    /// Intenta recargar la linterna. Consume una batería del inventario.
    /// Devuelve true si se recargó correctamente.
    /// </summary>
    ...
    /// <summary>Recoge una batería del mundo.</summary>
    ...
    /// <summary>
    /// Llamado por el EnemyBehaviourTree o cualquier sistema que mate al jugador.
    /// </summary>
    public void Die()
    {
        if (CurrentState == PlayerState.Dead) return;
        ...
        OnPlayerDied?.Invoke();
        Debug.Log("[PlayerState] JUGADOR MUERTO — esperando GameManager.");
    ...
    public bool CanThrow   => CurrentState != PlayerState.Aiming && CurrentState != PlayerState.Hiding;
